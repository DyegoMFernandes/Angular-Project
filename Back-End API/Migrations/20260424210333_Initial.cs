    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Description 1", 10.0m, "Teclado Gamer" },
                    { 2, "Description 2", 20.0m, "Mouse Gamer" },
                    { 3, "Description 3", 30.0m, "Impressora 3D" },
                    { 4, "Description 4", 40.0m, "Teclado Mecânico" }
                });

            migrationBuilder.InsertData(
                table: "Stock",
                columns: new[] { "StockID", "ProductID", "Quantity" },
                values: new object[,]
                {
                    { 1, 1, 100 },
                    { 2, 2, 100 },
